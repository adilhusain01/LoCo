    ...
    <section>
      <div className='rounded-lg h-64 overflow-hidden relative'>
        <Image
          ...
          src={`/assets/${shopData.data.design}.webp`}
          width={0}
          height={0}
        />
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center bg-white bg-opacity-70 px-16 py-8 rounded-lg shadow-xl backdrop-blur-sm'>
      ...
      <div className='flex flex-col mt-10'>
        {!shopData.data.products ? (
          <div className='sm:w-1/3 mx-auto text-center sm:py-8'>
            ...
            <ProductCreateDialog
              triggerElement={
                <Button className='gap-2 text-gray-600 bg-[#4acd8d] hover:bg-[#228c58] hover:text-white'>
                  <PlusCircle />
                  Add product
                </Button>
              }
